...
def main():
    ...
    # clip uses q_proj/k_proj/v_proj not qkv
    ...
    # save metric plots
    plot_save_dir = "./plots/clip-glaucoma"
    ...
    with open("../best_models/clip-glaucoma-benchmark.json", "w") as f:
        json.dump(benchmark, f, indent=4)

    plot_all_benchmark(
        source=benchmark,
        output_dir="../../plots/lora-final-plots/clip-glaucoma-benchmark-plots",
        skip=1,
        model_name="CLIP LoRA Glaucoma",
    )

    save_path = "../../best_models/best_clip_glaucoma_lora_model.pth"
    torch.save({
