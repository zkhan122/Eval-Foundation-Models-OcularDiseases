...
# augmenting ClipVisionModelWithProjection to add classification head (currently only feature extractor)
...
## Paper aligned hyperparams (based on eye clip): https://arxiv.org/pdf/2409.06644
NUM_CLASSES = 5
...
def main():
    ...
    save_path = "../best_models/best_clip_model.pth"
    torch.save({
