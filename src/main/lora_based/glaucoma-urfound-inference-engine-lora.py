...
def main():
    ...
    # save metric plots
    plot_save_dir = "./plots/urfound-glaucoma"
    ...
    with open("../../best_models/urfound-glaucoma-benchmark.json", "w") as f:
        json.dump(benchmark, f, indent=4)

    plot_all_benchmark(
        source=benchmark,
        output_dir="../../plots/lora-final-plots/urfound-glaucoma-benchmark-plots",
        skip=1,
        model_name="UrFound LoRA Glaucoma",
    )

    save_path = "../../best_models/best_urfound_glaucoma_lora_model.pth"
    torch.save({
