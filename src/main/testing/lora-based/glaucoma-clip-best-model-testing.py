...
def main():
    ...
    best_path = f"{SRC_DIR}/best_models/best_clip_glaucoma_lora_model.pth"
    ...
    # clip uses q_proj/k_proj/v_proj and modules_to_save=classifier
    ...
    os.makedirs("results/clip-glaucoma", exist_ok=True)
    results_path = "results/clip-glaucoma/clip_glaucoma_test_results.json"
    ...
    json_to_csv(results_path, "results/clip-glaucoma", "clip_glaucoma_results")
    
    np.save("../probs_numpy/clip_lora_glaucoma_true.npy", y_true)
    np.save("../probs_numpy/clip_lora_glaucoma_probs.npy", y_probs)
    ...
    plot_confusion_matrix_with_ci(
        ...
        title       = "CLIP-LoRA Glaucoma",
        save_path   = "../../../plots/confusion_matrices/glaucoma/lora/clip_cf.png",
    )
