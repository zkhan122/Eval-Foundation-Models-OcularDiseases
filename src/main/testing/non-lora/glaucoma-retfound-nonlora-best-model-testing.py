...
def main():
    ...
    best_path = f"{SRC_DIR}/best_models/best_retfound_glaucoma_nonlora_model.pth"
    ...
    os.makedirs("results/retfound-glaucoma-nonlora", exist_ok=True)
    results_path = "results/retfound-glaucoma-nonlora/retfound_glaucoma_nonlora_test_results.json"
