...
def main():
    ...
    best_path = f"{SRC_DIR}/best_models/best_urfound_glaucoma_nonlora_model.pth"
    ...
    # non-lora: load fine-tuned weights directly — no peft wrapping needed
    ...
    os.makedirs("results/urfound-glaucoma-nonlora", exist_ok=True)
    results_path = "results/urfound-glaucoma-nonlora/urfound_glaucoma_nonlora_test_results.json"
    ...
    json_to_csv(results_path, "results/urfound-glaucoma-nonlora", "urfound_glaucoma_nonlora_results")
    
    np.save("../probs_numpy/urfound_nonlora_glaucoma_true.npy", y_true)
    np.save("../probs_numpy/urfound_nonlora_glaucoma_probs.npy", y_probs)
    ...
    plot_confusion_matrix_with_ci(
        ...
        title       = "UrFound No-LoRa Glaucoma",
        save_path   = "../../../plots/confusion_matrices/glaucoma/non-lora/urfound_cf.png",
    )
