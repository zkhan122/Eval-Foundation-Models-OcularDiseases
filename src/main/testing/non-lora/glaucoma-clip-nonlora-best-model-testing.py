...
def main():
    ...
    best_path = f"{SRC_DIR}/best_models/best_clip_glaucoma_nonlora_model.pth"
    ...
    # non-lora: reconstruct wrapper then load fine-tuned weights directly
    ...
    os.makedirs("results/clip-glaucoma-nonlora", exist_ok=True)
    results_path = "results/clip-glaucoma-nonlora/clip_glaucoma_nonlora_test_results.json"
    ...
    np.save("../probs_numpy/clip_glaucoma_nonlora_true.npy", y_true)
    ...
    plot_confusion_matrix_with_ci(
        ...
        title       = "CLIP-No-LoRA Glaucoma",
        save_path   = "../../../plots/confusion_matrices/glaucoma/non-lora/clip_cf.png",
    )
