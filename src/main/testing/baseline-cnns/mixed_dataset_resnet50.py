...
def main():
    ...
    # loading checkpoint
    best_path  = f"{SRC_DIR}/best_models/best_resnet50_mixed_disease_model.pth"
    ...
    os.makedirs("results/resnet50-mixed-disease", exist_ok=True)
    results_path = "results/resnet50-mixed-disease/resnet50_mixed_30percentCI_test_results.json"
    ...
    json_to_csv(results_path, "results/resnet50-mixed-disease", "resnet50_mixed_disease_results")

    os.makedirs("../probs_numpy", exist_ok=True)
    # np.save("../probs_numpy/resnet50_mixed_disease_true.npy",  y_true)
    # np.save("../probs_numpy/resnet50_mixed_disease_probs.npy", y_probs)
    ...
    plot_confusion_matrix_with_ci(
        ...
        title       = "Mixed-Disease-ResNet50 DR Grading",
        save_path   = "../../../plots/confusion_matrices/mixed-disease/non-lora/resnet50_cf.png",
    )
